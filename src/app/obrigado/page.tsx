...
export default function ObrigadoPage() {
  const whatsappUrl = buildWhatsAppUrl(
    "Olá! Vi o diagnóstico no site e quero saber mais.",
  );
        ...
        <div className="w-full max-w-lg text-center">
          ...
          <div className="mt-8 space-y-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full bg-accent px-8 py-4 font-bold text-white shadow-lg shadow-[0_0_24px_var(--glow)] transition-all hover:shadow-[0_0_40px_var(--glow-strong)] hover:-translate-y-0.5"
            >
              <svg
                width="20"
                height="20"
