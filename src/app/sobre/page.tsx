        ...
        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
          ...
          <Reveal delay={150}>
            <aside className="rounded-2xl border border-border bg-card p-6">
              <p className="text-xs uppercase tracking-[0.24em] text-muted">Posicionamento</p>
              <div className="mt-6 space-y-3">
                <div className="rounded-xl border border-border bg-surface-overlay p-4">
                  <p className="font-medium text-primary">Consultoria direta</p>
                  <p className="mt-1 text-sm leading-6 text-secondary">
                    Fala técnica, sem rodeio e com foco no que fecha negócio.
                  </p>
                </div>
                <div className="rounded-xl border border-border bg-surface-overlay p-4">
                  <p className="font-medium text-primary">Entrega objetiva</p>
                  <p className="mt-1 text-sm leading-6 text-secondary">
